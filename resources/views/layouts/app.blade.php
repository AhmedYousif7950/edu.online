...
<head>
    ...
    <title>OnlineEdu - Dashboard</title>
...
<section id="container">
    ...
    <header class="header black-bg">
        ...
        <!--logo start-->
        <a href="index.html" class="logo"><b>Online<span>Edu</span></b></a>
        <!--logo end-->
    ...
    <aside>
        <div id="sidebar" class="nav-collapse ">
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <h5 class="centered" id="user_full_name">{{\Illuminate\Support\Facades\Auth::user()->first_name}} {{\Illuminate\Support\Facades\Auth::user()->last_name}}</h5>
                <h6 class="centered">{{\Illuminate\Support\Facades\Auth::user()->current_rank()}}</h6>
                <li class="mt">
                ...
                @if(isset($dashboard->sidebar['system']))
                    <li class="sub-menu">
                        <a href="javascript:;">
                        ...
                        <ul class="sub">
                            <li><a href="general.html">list</a></li>
                ...
                @endif
                @if(isset($dashboard->sidebar['mail']))
                    <li class="sub-menu">
                        <a href="javascript:;">
                ...
                @endif
                @if(isset($dashboard->sidebar['teachers']))
                    <li class="sub-menu">
                        <a href="javascript:;">
                ...
                @endif
                @if(isset($dashboard->sidebar['students']))
                    <li class="sub-menu">
                        <a href="javascript:;">
                ...
                @endif
                @if(isset($dashboard->sidebar['assignments']))
                    <li class="sub-menu">
                        <a href="javascript:;">
                ...
                @endif
                @if(isset($dashboard->sidebar['courses']))
                    <li class="sub-menu">
                        <a href="javascript:;">
...
<script type="text/javascript">
    $(document).ready(function() {
        var full_name =  $('#user_full_name').text();
        var unique_id = $.gritter.add({
            // (string | mandatory) the heading of the notification
            title: 'Welcome ' + "<span style='color:red;'>" + full_name + "</span>",
            // (string | mandatory) the text inside the notification
            text: full_name + ' Welcome to OnlineEdu!',
