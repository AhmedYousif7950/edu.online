...
<body>
  ...
  <script src="{{asset('assets')}}/lib/flot/jquery.flot.stack.js"></script>
  <script src="{{asset('assets')}}/lib/flot/jquery.flot.crosshair.js"></script>
  <script src="{{asset('assets')}}/lib/flotchart-conf.js"></script>
