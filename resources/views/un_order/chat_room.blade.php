          ...
          <aside class="mid-side">
            ...
            <div class="group-rom">
              ...
              <div class="second-part">
                ...
                <p><img class="{{asset('assets')}}/img-responsive" src="{{asset('assets')}}/img/product.jpg" alt=""></p>
              </div>
              <div class="third-part">12:32</div>
            </div>
            <div class="group-rom">
            ...
            <ul class="chat-available-user">
              <li>
                <a href="chat_room.html">
                  <img class="{{asset('assets')}}/img-circle" src="{{asset('assets')}}/img/friends/fr-02.jpg" width="32">
                  Paul Brown
              ...
              <li>
                <a href="chat_room.html">
                  <img class="{{asset('assets')}}/img-circle" src="{{asset('assets')}}/img/friends/fr-05.jpg" width="32">
                  David Duncan
              ...
              <li>
                <a href="chat_room.html">
                  <img class="{{asset('assets')}}/img-circle" src="{{asset('assets')}}/img/friends/fr-07.jpg" width="32">
                  Laura Smith
              ...
              <li>
                <a href="chat_room.html">
                  <img class="{{asset('assets')}}/img-circle" src="{{asset('assets')}}/img/friends/fr-08.jpg" width="32">
                  Julia Schultz
              ...
              <li>
                <a href="chat_room.html">
                  <img class="{{asset('assets')}}/img-circle" src="{{asset('assets')}}/img/friends/fr-01.jpg" width="32">
                  Frank Arias
