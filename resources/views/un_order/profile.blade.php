            ...
            <div class="row content-panel">
              ...
              <div class="col-md-4 centered">
                <div class="profile-pic">
                  <p><img src="{{asset('assets')}}/img/ui-sam.jpg" class="{{asset('assets')}}/img-circle"></p>
                  <p>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6 detailed">
                        ...
                        <div class="row centered mb">
                          <ul class="my-friends">
                            <li>
                              <div class="friends-pic"><img class="{{asset('assets')}}/img-circle" width="35" height="35" src="{{asset('assets')}}/img/friends/fr-01.jpg"></div>
                            </li>
                            <li>
                              <div class="friends-pic"><img class="{{asset('assets')}}/img-circle" width="35" height="35" src="{{asset('assets')}}/img/friends/fr-02.jpg"></div>
                            </li>
                            <li>
                              <div class="friends-pic"><img class="{{asset('assets')}}/img-circle" width="35" height="35" src="{{asset('assets')}}/img/friends/fr-03.jpg"></div>
                            </li>
                            <li>
                              <div class="friends-pic"><img class="{{asset('assets')}}/img-circle" width="35" height="35" src="{{asset('assets')}}/img/friends/fr-04.jpg"></div>
                            </li>
                            <li>
                              <div class="friends-pic"><img class="{{asset('assets')}}/img-circle" width="35" height="35" src="{{asset('assets')}}/img/friends/fr-05.jpg"></div>
                            </li>
                            <li>
                              <div class="friends-pic"><img class="{{asset('assets')}}/img-circle" width="35" height="35" src="{{asset('assets')}}/img/friends/fr-06.jpg"></div>
                            </li>
                            <li>
                              <div class="friends-pic"><img class="{{asset('assets')}}/img-circle" width="35" height="35" src="{{asset('assets')}}/img/friends/fr-07.jpg"></div>
                            </li>
                            <li>
                              <div class="friends-pic"><img class="{{asset('assets')}}/img-circle" width="35" height="35" src="{{asset('assets')}}/img/friends/fr-08.jpg"></div>
                            </li>
                            <li>
                              <div class="friends-pic"><img class="{{asset('assets')}}/img-circle" width="35" height="35" src="{{asset('assets')}}/img/friends/fr-09.jpg"></div>
                            </li>
                            <li>
                              <div class="friends-pic"><img class="{{asset('assets')}}/img-circle" width="35" height="35" src="{{asset('assets')}}/img/friends/fr-10.jpg"></div>
                            </li>
                            <li>
                              <div class="friends-pic"><img class="{{asset('assets')}}/img-circle" width="35" height="35" src="{{asset('assets')}}/img/friends/fr-11.jpg"></div>
                            </li>
                          </ul>
                          <div class="row mt">
