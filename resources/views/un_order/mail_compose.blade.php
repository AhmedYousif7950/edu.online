...
<head>
  ...
  <link href="{{asset('assets')}}/lib/bootstrap-wysihtml5/bootstrap-wysihtml5.css" rel="stylesheet" />
...
<body>
            ...
            <section class="panel">
              <div class="panel-body">
                <ul class="nav nav-pills nav-stacked labels-info ">
                  ...
                  <li>
                    <a href="#">
                        <img src="{{asset('assets')}}/img/friends/fr-10.jpg" class="{{asset('assets')}}/img-circle" width="20">Laura
                        <p><span class="label label-success">Available</span></p>
                      </a>
                  </li>
                  <li>
                    <a href="#">
                        <img src="{{asset('assets')}}/img/friends/fr-05.jpg" class="{{asset('assets')}}/img-circle" width="20">David
                        <p><span class="label label-danger"> Busy</span></p>
                      </a>
                  </li>
                  <li>
                    <a href="#">
                        <img src="{{asset('assets')}}/img/friends/fr-01.jpg" class="{{asset('assets')}}/img-circle" width="20">Mark
                        <p>Offline</p>
                      </a>
                  </li>
                  <li>
                    <a href="#">
                        <img src="{{asset('assets')}}/img/friends/fr-03.jpg" class="{{asset('assets')}}/img-circle" width="20">Phillip
                        <p>Offline</p>
                      </a>
                  </li>
                  <li>
                    <a href="#">
                        <img src="{{asset('assets')}}/img/friends/fr-02.jpg" class="{{asset('assets')}}/img-circle" width="20">Joshua
                        <p>Offline</p>
                      </a>
                  </li>
                </ul>
  ...
  <script type="text/javascript" src="{{asset('assets')}}/lib/bootstrap-wysihtml5/wysihtml5-0.3.0.js"></script>
  <script type="text/javascript" src="{{asset('assets')}}/lib/bootstrap-wysihtml5/bootstrap-wysihtml5.js"></script>
