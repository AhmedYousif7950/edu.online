...
<head>
  ...
  <link rel="stylesheet" href="{{asset('assets')}}/lib/xchart/xcharts.css">
...
<body>
  ...
  <script src="{{asset('assets')}}/lib/xchart/d3.v3.min.js"></script>
  <script src="{{asset('assets')}}/lib/xchart/xcharts.min.js"></script>
  <script>
    (function() {
      var data = [{
        "xScale": "ordinal",
