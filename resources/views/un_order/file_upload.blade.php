...
<head>
  ...
  <noscript>
      <link rel="stylesheet" href="{{asset('assets')}}/lib/file-uploader/css/jquery.fileupload-noscript.css">
    </noscript>
  <noscript>
      <link rel="stylesheet" href="{{asset('assets')}}/lib/file-uploader/css/jquery.fileupload-ui-noscript.css">
    </noscript>
...
<body>
  ...
  <script src="{{asset('assets')}}/lib/file-uploader/js/vendor/jquery.ui.widget.js"></script>
  ...
  <script src="{{asset('assets')}}/lib/file-uploader/js/jquery.iframe-transport.js"></script>
  <!-- The basic File Upload plugin -->
  <script src="{{asset('assets')}}/lib/file-uploader/js/jquery.fileupload.js"></script>
  <!-- The File Upload processing plugin -->
  <script src="{{asset('assets')}}/lib/file-uploader/js/jquery.fileupload-process.js"></script>
  <!-- The File Upload image preview & resize plugin -->
  <script src="{{asset('assets')}}/lib/file-uploader/js/jquery.fileupload-image.js"></script>
  <!-- The File Upload audio preview plugin -->
  <script src="{{asset('assets')}}/lib/file-uploader/js/jquery.fileupload-audio.js"></script>
  <!-- The File Upload video preview plugin -->
  <script src="{{asset('assets')}}/lib/file-uploader/js/jquery.fileupload-video.js"></script>
  <!-- The File Upload validation plugin -->
  <script src="{{asset('assets')}}/lib/file-uploader/js/jquery.fileupload-validate.js"></script>
  <!-- The File Upload user interface plugin -->
  <script src="{{asset('assets')}}/lib/file-uploader/js/jquery.fileupload-ui.js"></script>
  <!-- The main application script -->
  <script src="{{asset('assets')}}/lib/file-uploader/js/main.js"></script>
