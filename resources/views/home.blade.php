            ...
            <div class="header-top d-none d-lg-block">
                ...
                <div class="header-left-social">
                    <ul class="header-social">
                        <li><a href="{{$website_info->twitter}}"><i class="fab fa-twitter"></i></a></li>
                        <li><a href="{{$website_info->facebook}}"><i class="fab fa-facebook-f"></i></a></li>
                        <li><a href="{{$website_info->linked_in}}"><i class="fab fa-linkedin-in"></i></a></li>
                    </ul>
                </div>
                <div class="container">
                    <div class="col-xl-12">
                        <div class="row d-flex justify-content-between align-items-center">
                            <div class="header-info-left" style="margin: auto">
                                <ul>
                                    <li>{{$website_info->phone}}</li>
                                </ul>
                            </div>
                            <div class="header-info-right">
                                <ul>
                                    ...
                                    @if(\Illuminate\Support\Facades\Auth::check())
                                        <li><a href="{{route('dashboard')}}"><i class="ti-layout-grid2-alt"></i>Dashboard</a></li>
            ...
            <div class="single-slider slider-height d-flex align-items-center">
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-6 col-lg-5">
                            <div class="hero-man d-none d-lg-block f-right" data-animation="jello" data-delay=".4s">
                                <img src="{{asset('assets/img/hero/heroman.png')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row justify-content-between">
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                ...
                                <div class="single-counter text-center">
                                    ...
                                    <span class="counter color-green">{{$website_info->total_courses}}</span>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                ...
                                <div class="single-counter text-center">
                                    ...
                                    <span class="counter color-blue">{{$website_info->total_students}}</span>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                ...
                                <div class="single-counter text-center">
                                    ...
                                    <span class="counter color-green">{{$website_info->total_assignments}}</span>
                                    <p class="color-green">+ Assignments</p>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                ...
                                <div class="single-counter text-center">
                                    ...
                                    <span class="counter color-red">{{$website_info->total_teachers}}</span>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    ...
                    <div class="single-course mb-40">
                        <div class="course-img">
                            <img src="{{asset('assets/img/gallery/popular_sub2.png')}}" alt="">
                        </div>
                        <div class="course-caption">
                            ...
                            <div class="course-cap-bottom d-flex justify-content-between">
                                <ul>
                                    <li><i class="ti-user"></i> {{$course->students->count()}}</li>
                                </ul>
                                <span>Free</span>
                            </div>
                        </div>
                    ...
                    <div class="h1-testimonial-active">
                        ...
                        <div class="single-testimonial pt-65">
                            ...
                            <div class="testimonial-icon mb-45">
                                <img src="{{asset('assets/img/gallery/testimonial.png')}}" class="ani-btn " alt="">
                            </div>
